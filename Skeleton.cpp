...
Skeleton::Skeleton(SDL_Renderer* r, Point spawn)
{
	type = ENEMY;
	size = SMALL_NME;
	...
	texture.LoadTexture(r, "resources//Skeleton.png");
...
void Skeleton::HandleCollision(int collided, int damage)
{
